...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler
  ...
  private static final ThreadLocal<ApiExceptionHandler> requestInfoThreadLocal =
          new ThreadLocal<>();
  ...
  // Implementation of RequestBodyAdvice to capture the request body and be able to add it to the
  // report in case of an error
