<#-- @ftlvariable name="registrationLink" type="java.lang.String" -->
                                                ...
                                                <tr>
                                                    <td role="modules-container"
                                                        ...
                                                        <table class="wrapper" role="module" data-type="image"
                                                               ...
                                                               data-muid="60071fc0-480c-4bcb-bc47-918b09c5a096">
                                                            <tbody>
                                                            <tr>
                                                                <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;"
                                                                    ...
                                                                    <img class="max-width" border="0"
                                                                         ...
                                                                         src="http://cdn.mcauto-images-production.sendgrid.net/dae297399db05874/4a460286-5ea0-4694-b10e-77ab7149443b/4500x2084.png">
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                        <table class="module" role="module" data-type="text" border="0"
                                                               ...
                                                               style="table-layout: fixed;"
                                                               data-muid="52db5f54-74af-4e0a-91f2-ba3a943cdf8c"
                                                                ...
                                                                <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;"
                                                                    ...
                                                                    <div>
                                                                        <div style="font-family: inherit; text-align: inherit">
                                                                            <span style="font-family: &quot;lucida sans unicode&quot;, &quot;lucida grande&quot;, sans-serif">Hello there 🚀</span>
                                                                        </div>
                                                                        <div style="font-family: inherit; text-align: inherit">
                                                                            <br></div>
                                                                        <div style="font-family: inherit; text-align: inherit">
                                                                            <span style="font-family: &quot;lucida sans unicode&quot;, &quot;lucida grande&quot;, sans-serif">To complete your registration, please click in the following button and complete the form</span>
                                                                        </div>
                                                                        <div></div>
                                                                    </div>
                                                                </td>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" class="module"
                                                               ...
                                                               data-muid="beb7f492-571d-4b95-8d5b-dda6612cf5c8">
                                                            <tbody>
                                                            <tr>
                                                                <td align="center" bgcolor="" class="outer-td"
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tbody>
                                                                        <tr>
                                                                            <td align="center" bgcolor="#240fd0"
                                                                                class="inner-td"
                                                                                style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                                                                                <a href="${registrationLink}"
                                                                                   style="background-color:#240fd0; border:1px solid #333333; border-color:#333333; border-radius:6px; border-width:1px; color:#ffffff; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 18px 12px 18px; text-align:center; text-decoration:none; border-style:solid; font-family:lucida sans unicode,lucida grande,sans-serif;"
                                                        ...
                                                        <table class="module" role="module" data-type="text" border="0"
                                                               cellpadding="0" cellspacing="0" width="100%"
                                                               style="table-layout: fixed;"
                                                               data-muid="a3d7075b-a74a-475e-ac3f-48d86624916e"
                                                               data-mc-module-version="2019-10-22">
                                                            <tbody>
                                                            <tr>
                                                                <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;"
